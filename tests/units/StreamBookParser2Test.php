...
class StreamBookParser2Test extends TestCase
{
    /** @var StreamBookParser2 */
    private $parser;
    ...
    {
        $this->iniParser();
        $this->assertTrue(is_a($this->parser, StreamBookParser2::class));
    }
...
ONIX
    ...
    {
        $this->parser = new StreamBookParser2;
