...
class StreamBookParserTest extends TestCase
{
    /** @var StreamBookParser */
    private $parser;
    /** @var array|Product[] */
    private $products = [];
    ...
    {
        $this->iniParser();
        $this->assertTrue(is_a($this->parser, StreamBookParser::class));
    }
...
ONIX
    ...
    {
        $this->parser = new StreamBookParser;
