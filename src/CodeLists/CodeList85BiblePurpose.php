...
class CodeList85BiblePurpose extends CodeList
{
    public const KEY = 'BiblePurpose';
    ...
    protected const MAPPING = [
        ...
        "GF" => "Gift",
        /* A large Bible (or selected Biblical text) with large print designed for use in reading scriptures in public worship from either
					the pulpit or lectern */
        "LP" => "Lectern/Pulpit",
        ...
        "ST" => "Student",
        /* A Bible (or selected Biblical text) with many extra features, e.g. book introductions, dictionary, concordance, references,
					maps, etc., to help readers better understand the scripture */
        "SU" => "Study",
